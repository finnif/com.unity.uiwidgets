...
class Build
{
    ...
    private static bool IsHostWindows = false;
    private static bool IsHostMacOS = false;
    ...
    static void Main()
    {
        ...
        if (IsHostMacOS)
        {
            BuildMac.Build(skiaRoot, flutterRoot);
            return;
        }
    ...
    static NativeProgram SetupLibUIWidgets()
    {
        ...
        np.Defines.Add("UIWIDGETS_OS_WIN=\\\"1\\\"");
